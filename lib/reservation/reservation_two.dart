...
class ReservationScreenTwo extends StatefulWidget {
  const ReservationScreenTwo({super.key});

  @override
  State<ReservationScreenTwo> createState() => _ReservationScreenTwoState();
}

class _ReservationScreenTwoState extends State<ReservationScreenTwo>
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // Tabs inside white rounded container
            Padding(
