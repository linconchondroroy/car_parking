...
class FavoriteScreenSix extends StatefulWidget {
  const FavoriteScreenSix({super.key});

  @override
  State<FavoriteScreenSix> createState() => _FavoriteScreenSixState();
}

class _FavoriteScreenSixState extends State<FavoriteScreenSix> {
  // Colors
