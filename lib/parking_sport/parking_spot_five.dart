...
class ParkingSpotFive extends StatefulWidget {
  const ParkingSpotFive({super.key});

  @override
  State<ParkingSpotFive> createState() => _ParkingSpotFiveState();
}

class _ParkingSpotFiveState extends State<ParkingSpotFive> {
  // THEME
