...
class ParkingSpotSeven extends StatefulWidget {
  const ParkingSpotSeven({super.key});

  @override
  State<ParkingSpotSeven> createState() => _ParkingSpotSevenState();
}

class _ParkingSpotSevenState extends State<ParkingSpotSeven> {
