...
class ParkingSpotSix extends StatefulWidget {
  const ParkingSpotSix({super.key});

  @override
  State<ParkingSpotSix> createState() => _ParkingSpotSixState();
}

class _ParkingSpotSixState extends State<ParkingSpotSix> {
  // Colors
