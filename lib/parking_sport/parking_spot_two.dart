...
class ParkingSpotTwo extends StatefulWidget {
  const ParkingSpotTwo({super.key});

  @override
  State<ParkingSpotTwo> createState() => _HomeScreenFiveState();
}

class _HomeScreenFiveState extends State<ParkingSpotTwo> {
  // --- THEME COLORS ---
