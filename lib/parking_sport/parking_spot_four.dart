...
class ParkingSpotFour extends StatefulWidget {
  const ParkingSpotFour({super.key});

  @override
  State<ParkingSpotFour> createState() => _HomeScreenSevenState();
}

class _HomeScreenSevenState extends State<ParkingSpotFour> {
  // 🎨 Theme colors
