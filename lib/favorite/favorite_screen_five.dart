...
class FavoriteScreenFive extends StatefulWidget {
  const FavoriteScreenFive({super.key});

  @override
  State<FavoriteScreenFive> createState() => _FavoriteScreenFiveState();
}

class _FavoriteScreenFiveState extends State<FavoriteScreenFive> {
  // THEME
